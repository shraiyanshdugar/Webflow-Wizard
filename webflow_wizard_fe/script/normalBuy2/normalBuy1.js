...
var displayCurrOwner = document.querySelector('#currentOwner2');
var user1Check = document.querySelector('#user1err2');
var stopScriptsOnErr = document.querySelector('#stopTheScripts2');
var maxValueCheck = document.querySelector('#maxValueErr2');
var maxValueReached = document.querySelector('#maxValueReached2');
