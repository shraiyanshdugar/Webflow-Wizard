...
var displayCurrOwner = document.querySelector('#currentOwner3');
var user1Check = document.querySelector('#user1err3');
var stopScriptsOnErr = document.querySelector('#stopTheScripts3');
var maxValueCheck = document.querySelector('#maxValueErr3');
var maxValueReached = document.querySelector('#maxValueReached3');
